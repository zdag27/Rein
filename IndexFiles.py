...
if __name__ == '__main__':
    ...
    #[{'host': 'localhost', 'port': 9200,http_auth=("icelasticsearch","password")}]
    #Elasticsearch(['http://localhost:8080'], http_auth=('user', 'pass'))
    #Elasticsearch(hosts="http://elastic:changeme@localhost:9200/")
    #curl -X GET "elastic:changeme@localhost:9200/"
    '''["xxx.xxx.xxx.xxx", "xxx.xxx.xxx.xxx", "xxx.xxx.xxx.xxx"],
 
    http_auth=("icelasticsearch","password"),
